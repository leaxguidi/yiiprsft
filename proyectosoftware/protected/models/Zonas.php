 ...
 * @property string $lngi
 * @property string $latf
 * @property string $lngf
 */
class Zonas extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('lngi',$this->lngi,true);
		$criteria->compare('latf',$this->latf,true);
		$criteria->compare('lngf',$this->lngf,true);
