<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('account_verification_code')); ?>:</b>
	<?php echo CHtml::encode($data->account_verification_code); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('fecha_ultimo_login')); ?>:</b>
	<?php echo CHtml::encode($data->fecha_ultimo_login); ?>
	<br />
